...
function Createqurey() {
  ...
  const handleCreate = async () => {
    const insertedResponse = await axios.post(
      "https://qurey-system-org.onrender.com/Qurey/create",
      {
        data: {
  ...
  return (
    <>
      <Grid container spacing={2}>
        ...
        <Grid item xs={8}>
          <h1 className="mt-5">Create Your Qurey</h1>
          ...
          <div className="details_container">
            ...
            <input
              type="text"
              name="title"
              value={qureydata.title}
              onChange={(e) => {
                commonchange(e);
              }}
              className="form-control"
              placeholder="QureyTitle"
              aria-label="QureyTitle"
          ...
          <Button variant="contained" sx={{ mt: 3, mb: 2 }} onClick={handleCreate}>
            Create
          </Button>
        </Grid>
      </Grid>
